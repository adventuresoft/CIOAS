...
Route::group([ 'prefix' => 'dashboard', 'middleware' => [ 'auth', 'module.permission' ] ], function () {
...
// Frontend Dropdown Ajax Routes
Route::get('/frontend-get-districts-by-division/{divisionID}', [ DistrictController::class, 'districtsByDivision' ]);
Route::get('/frontend-get-thanas-by-district/{districtID}', [ ThanaController::class, 'thanasByDistrict' ]);
Route::get('/frontend-get-postOffice-by-thana/{thanaID}', [ PostOfficeController::class, 'postOfficeByThana' ]);
