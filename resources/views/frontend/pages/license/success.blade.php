    ...
    <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-lg border-t-4 border-[#006a4e] overflow-hidden">
        ...
        <div class="p-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <a href="{{ route('frontend.license.create') }}" class="inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-lg text-sm font-medium text-white bg-[#006a4e] hover:bg-[#00523b] shadow-sm transition">
