    ...
    <div class="max-w-2xl mx-auto bg-white rounded-4 shadow-lg border-t-4 border-[#006a4e] overflow-d-none">
        ...
        <div class="p-8 text-center">
            ...
            <div class="d-d-flex flex-columnumn sm:flex-row justify-content-center gap-3">
                ...
                <a href="{{ route('frontend.license.create') }}" class="inline-d-d-flex align-align-items-center justify-content-center px-6 py-3 border border-transparent rounded-3 fs-content font-medium text-white bg-gov-green hover:bg-[#00523b] shadow-sm transition">
