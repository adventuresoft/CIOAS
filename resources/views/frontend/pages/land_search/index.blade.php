...
@section('content')
            ...
            <form action="{{ route('frontend.land.search') }}" method="GET">
                ...
                <div class="row g-4 mb-3">
                    <div class="col-md-3">
                        ...
                        <input type="text" name="dag_no" value="{{ request('dag_no') }}" class="form-control" id="dag_no"
                            placeholder="দাগ নং">
                    </div>
                </div>

                <!-- Footer Buttons -->
                <div class="d-flex justify-content-end gap-3 mt-3 border-t pt-4">
    ...
    @if($lands !== null)
        <div class="bg-white rounded-3 shadow-sm border-top border-5 border-success p-3 mt-3" id="print-section">
            <div
                class="d-flex align-align-items-center gap-3 border-bottom border-3 border-danger pb-3 mb-3 d-flex justify-content-between align-align-items-center no-print">
                <div>
