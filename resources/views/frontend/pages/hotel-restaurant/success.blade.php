...
<div class="container py-12">
    <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-lg border-t-4 border-[#006a4e] overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-[#006a4e] to-[#00523b] p-6 text-white text-center border-b border-[#f42a41]/20">
            ...
            <h2 class="text-2xl font-bold">আবেদন সম্পন্ন হয়েছে!</h2>
        ...
        <div class="p-8 text-center">
            @if ($application_id)
                <div class="bg-green-50 rounded-lg p-6 border border-green-100 mb-6">
                    <p class="text-sm text-gray-500 font-semibold mb-2">আপনার আবেদন আইডি (Application ID):</p>
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <a href="{{ route('frontend.hotel-restaurant.create') }}" class="inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-lg text-sm font-medium text-white bg-[#006a4e] hover:bg-[#00523b] shadow-sm transition">
