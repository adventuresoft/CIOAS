    ...
    <div class="container pt-3">
        <div class="bg-white rounded-3 shadow-sm border-top border-5 border-success p-3">
            ...
            <div class="d-d-flex align-align-items-center gap-3 border-bottom border-3 border-danger pb-3 mb-3">
                <div>
                    <h4 class="fw-semibold">হোটেল ও রেস্তোরাঁ আবেদন ফরম</h4>
            ...
            <div class="gov-body">
                <form id="publicHotelForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-d-flex justify-content-end gap-3 mt-8 border-t pt-4">
                        ...
                        <button type="button" id="btn-next-step" class="btn btn-gov-submit">পরবর্তী ধাপ <i class="fas fa-arrow-right ms-2"></i></button>
                    </div>
                    </div> <!-- End Step 1 -->

                    <div id="step-2" class="d-none">
                        <h4 class="mb-4 text-center fw-bold text-success border-bottom pb-2">মালিক/পরিচালকের তথ্য (Ownership Information)</h4>
                        ...
                        <div class="d-d-flex justify-content-between gap-3 mt-8 border-t pt-4">
                            <button type="button" id="btn-prev-step" class="btn btn-gov-cancel"><i class="fas fa-arrow-left me-2"></i> পূর্ববর্তী ধাপ</button>
                            <button type="submit" class="btn btn-gov-submit">আবেদন সম্পন্ন করুন <i class="fas fa-check-circle ms-2"></i></button>
                        </div>
                    </div>
                            ...
                            <div class="card-body bg-light p-4">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="owner_name_bn[]" class="form-control" placeholder="Name Bangla" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="owner_birth_certificate[]" class="form-control" placeholder="Birth Reg. No.">
                                    </div>
                                    <div class="col-md-4">
                                        <label>NID No.</label>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="owner_father_name[]" class="form-control" placeholder="Father Name English" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Father Name (Bangla) <span class="text-danger">*</span></label>
                                        <input type="text" name="owner_father_name_bn[]" class="form-control" placeholder="Father Name Bangla" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="owner_mother_name[]" class="form-control" placeholder="Mother Name English" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Mother Name (Bangla) <span class="text-danger">*</span></label>
                                        <input type="text" name="owner_mother_name_bn[]" class="form-control" placeholder="Mother Name Bangla" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4 mb-3">
                                    <div class="col-12">
                                        <h6 class="text-dark fw-bold border-bottom pb-2"><i class="fas fa-home text-muted mr-2"></i> Permanent Address</h6>
                                    </div>
                                </div>
                                    ...
                                    <div class="row align-align-items-center mb-3 pt-2">
                                        ...
                                        <div class="col-md-9">
                                            <div class="d-d-flex align-align-items-center flex-wrap gap-3">
                                                ...
                                                <label class="location-type-card owner-address-type-card">
                                                    <input type="radio" name="owner_permanent_location_type___INDEX__" value="union_type"
                                                        class="location-type-radio d-none owner-perm-location-type-radio">
                                                    <i class="fas fa-warehouse location-icon"></i>
                                                    <span>ইউনিয়ন (Union)</span>
                                                </label>
                                    ...
                                    <div class="owner-perm-fields d-none">
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                ...
                                                <select name="owner_permanent_division[]" class="form-control select2 owner-address-division">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select name="owner_permanent_district[]" class="form-control select2 owner-address-district">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-4 owner-perm-city-type d-none">
                                                ...
                                                <select name="owner_permanent_city[]" class="form-control select2 owner-address-city" data-type="city">
                                                    <option value="">Select City Corporation</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4 owner-perm-pos-type d-none">
                                                <label>Pourashava</label>
                                                <select name="owner_permanent_pourashava[]" class="form-control select2 owner-address-pourashava" data-type="pos">
                                                    <option value="">Select Pourashava</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4 owner-perm-union-type d-none">
                                                <label>Union</label>
                                                <select name="owner_permanent_union[]" class="form-control select2 owner-address-union" data-type="union">
                                                    <option value="">Select Union</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                <label>Post Office</label>
                                                <select name="owner_permanent_post_office[]" class="form-control select2 owner-address-post-office">
                                                    <option value="">Select Post Office</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                <label>Village</label>
                                                <select name="owner_permanent_village_id[]" class="form-control select2 owner-address-village">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-3">
                                                <label>Road</label>
                                                <input type="text" name="owner_permanent_road[]" class="form-control" placeholder="Permanent Road">
                                            </div>
                                            <div class="col-md-3">
                                                <label>Holding/House No.</label>
                                                <input type="text" name="owner_permanent_house[]" class="form-control" placeholder="Permanent House">
                                            </div>
                                            <div class="col-md-3">
                                                <label>Holding/House No. (Bangla)</label>
                                                <input type="text" name="owner_permanent_house_bn[]" class="form-control" placeholder="স্থায়ী বাড়ি">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4 mb-3">
                                    <div class="col-12">
                                        <h6 class="text-dark fw-bold border-bottom pb-2"><i class="fas fa-map-marker-alt text-muted mr-2"></i> Present Address</h6>
                                    </div>
                                </div>
                                ...
                                <div class="owner-present-address-section">
                                    ...
                                    <div class="owner-present-fields d-none">
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                <label>Division</label>
                                                <select name="owner_present_division[]" class="form-control select2 owner-address-division">
                                                    <option value="">Select Division</option>
                                                    @foreach ($divisions as $division)
                                                        <option value="{{ $division->id }}">{{ $division->name }}</option>
                                                    @endforeach
                                            ...
                                            <div class="col-md-4">
                                                <label>District</label>
                                                <select name="owner_present_district_id[]" class="form-control select2 owner-address-district">
                                                    <option value="">Select District</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                <label>Thana</label>
                                                <select name="owner_present_thana_id[]" class="form-control select2 owner-address-thana">
                                                    <option value="">Select Thana</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-4 owner-present-city-type d-none">
                                                <label>City Corporation</label>
                                                <select name="owner_present_city[]" class="form-control select2 owner-address-city" data-type="city">
                                                    <option value="">Select City Corporation</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4 owner-present-pos-type d-none">
                                                <label>Pourashava</label>
                                                <select name="owner_present_pourashava[]" class="form-control select2 owner-address-pourashava" data-type="pos">
                                                    <option value="">Select Pourashava</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4 owner-present-union-type d-none">
                                                <label>Union</label>
                                                <select name="owner_present_union[]" class="form-control select2 owner-address-union" data-type="union">
                                                    <option value="">Select Union</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                <label>Post Office</label>
                                                <select name="owner_present_post_office_id[]" class="form-control select2 owner-address-post-office">
                                                    <option value="">Select Post Office</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                <label>Village</label>
                                                <select name="owner_present_village_id[]" class="form-control select2 owner-address-village">
                                                    <option value="">Select Village</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-3">
                                                <label>Road</label>
                                                <input type="text" name="owner_present_road[]" class="form-control" placeholder="Present Road">
                                            </div>
                                            <div class="col-md-3">
                                                <label>House</label>
                                                <input type="text" name="owner_present_house[]" class="form-control" placeholder="Present House">
                                            </div>
                                            <div class="col-md-3">
                                                <label>House (Bangla)</label>
                                                <input type="text" name="owner_present_house_bn[]" class="form-control" placeholder="বর্তমান বাড়ি">
                                            </div>
                                        </div>
                                    </div>
                                </div>
