...
<div class="container py-8">
    <div class="gov-form-container">
        ...
        <div class="gov-header">
            ...
            <div>
                <h2>হোটেল ও রেস্তোরাঁ আবেদন ফরম</h2>
            ...
            <form id="publicHotelForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-4 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" required name="name" placeholder="Enter Hotel/Restaurant Name" class="form-control" id="name">
                        <small class="error-text error name_error"></small>
                    </div>
                    <div class="col-md-6">
                        <label for="bn_name">প্রতিষ্ঠানের নাম (বাংলা)</label>
                        <input type="text" name="bn_name" placeholder="হোটেল/রেস্তোরাঁর বাংলা নাম লিখুন" class="form-control" id="bn_name">
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-md-4">
                        <label for="organization_subcategory_id">সাব-ক্যাটেগরি <span class="text-danger">*</span></label>
                        <select class="form-control select2" name="organization_subcategory_id" id="organization_subcategory_id" required>
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-md-4 d-none" id="no_of_owner_div">
                        ...
                        <input type="number" name="no_of_owner" placeholder="Number of Owners" class="form-control" id="no_of_owner">
                    ...
                    <div class="col-md-4 d-none" id="no_of_dir_div">
                        ...
                        <input type="number" name="no_of_dir" placeholder="Number of Directors" class="form-control" id="no_of_dir">
                        <small class="error-text error no_of_dir_error"></small>
                    </div>
                    <div class="col-md-4">
                        <label for="capital">মূলধন (টাকা)</label>
                        <input type="number" name="capital" placeholder="Capital Amount" class="form-control" id="capital">
                        <small class="error-text error capital_error"></small>
                    </div>
                    <div class="col-md-4">
                        <label for="establish_year">প্রতিষ্ঠার সাল</label>
                        <input type="number" min="1900" max="{{ date('Y') }}" name="establish_year" value="{{ date('Y') }}" class="form-control" id="establish_year">
                ...
                <div class="present_address_filed d-none mb-4">
                    ...
                    <div class="row g-4 mb-3">
                        ...
                        <div class="col-md-4 city_type d-none">
                            ...
                            <select name="city_id" class="form-control select2" id="city_corporation_id" data-type="City" disabled>
                        ...
                        <div class="col-md-4 pos_type d-none">
                            ...
                            <select name="pos_id" class="form-control select2" id="pourashova_id" data-type="pourashova" disabled>
                        ...
                        <div class="col-md-4 union_type d-none">
                            ...
                            <select name="union_id" class="form-control select2" id="union_id" data-type="union" disabled>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="house_bn" class="form-control" id="house_bn" placeholder="বাসা নম্বর বাংলা">
                ...
                <div class="office_address_field d-none mb-4">
                    <div class="row g-4 mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="office_district_id" class="form-control select2" id="office_district_id" disabled>
                                <option value="">জেলা নির্বাচন করুন</option>
                            </select>
                    ...
                    <div class="row g-4 mb-3">
                        ...
                        <div class="col-md-4 office_city_type d-none">
                            ...
                            <select name="office_city_id" class="form-control select2" id="office_city_corporation_id" data-type="City" disabled>
                                <option value="">সিটি কর্পোরেশন নির্বাচন করুন</option>
                            </select>
                        ...
                        <div class="col-md-4 office_pos_type d-none">
                            ...
                            <select name="office_pos_id" class="form-control select2" id="office_pourashova_id" data-type="pourashova" disabled>
                                <option value="">পৌরসভা নির্বাচন করুন</option>
                            </select>
                        ...
                        <div class="col-md-4 office_union_type d-none">
                            ...
                            <select name="office_union_id" class="form-control select2" id="office_union_id" data-type="union" disabled>
                                <option value="">ইউনিয়ন নির্বাচন করুন</option>
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="office_post_office_id" class="form-control select2" id="office_post_office_id" disabled>
                                <option value="">পোস্ট অফিস নির্বাচন করুন</option>
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="office_village_id" class="form-control select2" id="office_village_id" disabled>
                                <option value="">গ্রাম নির্বাচন করুন</option>
                            </select>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="office_road" class="form-control" id="office_road" placeholder="Road Name">
                            <small class="error-text error office_road_error"></small>
                        </div>
                        <div class="col-md-3">
                            <label for="office_house">হোল্ডিং/বাসা নং</label>
                            <input type="text" name="office_house" class="form-control" id="office_house" placeholder="House No">
                            <small class="error-text error office_house_error"></small>
                        </div>
                        <div class="col-md-3">
                            <label for="office_house_bn">হোল্ডিং/বাসা নং (বাংলা)</label>
                            <input type="text" name="office_house_bn" class="form-control" id="office_house_bn" placeholder="বাসা নম্বর বাংলা">
