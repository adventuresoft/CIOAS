...
@section('content')
    ...
    <div class="theme-form-card">
            ...
            <form id="publicHotelForm" method="POST" enctype="multipart/form-data">
                ...
                <div id="step-1">
                    ...
                    <div class="row align-align-items-center mb-3 pt-2">
                        ...
                        <div class="col-md-10">
                            <div class="d-flex align-align-items-center flex-wrap gap-3">
        ...
        <div class="d-flex justify-content-end gap-3 border-t pt-4">
    ...
    <div id="step-2" class="d-none">
        ...
        <div class="d-flex justify-content-between gap-3 mt-8 border-t pt-4">
            ...
            <div class="card-body bg-light p-4">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="owner_father_name[]" class="form-control" placeholder="Father Name English"
                            required>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="owner_mother_name[]" class="form-control" placeholder="Mother Name English"
                            required>
                    </div>
                    <div class="col-md-6">
