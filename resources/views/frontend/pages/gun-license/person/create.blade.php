        ...
        <div class="bg-white rounded-3 shadow-sm border-top border-5 border-success p-3">
            ...
            <div class="gov-body">
                <form id="publicPersonGunForm" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- 1. Primary Details -->
                    <h5 class="section-title fs-6"><i class="fas fa-file-alt"></i> আবেদনের প্রাথমিক তথ্য</h5>
                    <div class="row g-4 mb-3">
                        <div class="col-md-6">
                            <label for="district_magistrate">জেলা ম্যাজিস্ট্রেট <span class="text-danger">*</span></label>
                            <input type="text" name="district_magistrate" class="form-control" id="district_magistrate"
                                required placeholder="যেমন: ঢাকা">
                    ...
                    <!-- 2. Personal Details -->
                    <h5 class="section-title fs-6"><i class="fas fa-user"></i> আবেদনকারীর বিবরণ</h5>
                    <div class="row g-4 mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="applicant_name" class="form-control" id="applicant_name" required
                                placeholder="বাংলায় পুরো নাম ও ডাকনাম">
                            <small class="error-text error applicant_name_error"></small>
                        </div>
                        <div class="col-md-4">
                            <label for="applicant_name_en">আবেদনকারীর নাম ইংরেজীতে <span
                                    class="text-danger">*</span></label>
                            <input type="text" name="applicant_name_en" class="form-control" id="applicant_name_en" required
                                placeholder="ইংরেজীতে বড় অক্ষরে নাম">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="nid_no" class="form-control" id="nid_no" required
                                placeholder="NID বা স্মার্ট কার্ড নম্বর">
                    ...
                    <div class="row g-4 mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" name="age_at_application" class="form-control" id="age_at_application"
                                required placeholder="আবেদনের তারিখে বয়স">
                    ...
                    <div class="row g-4 mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="phone" class="form-control" id="phone" required
                                placeholder="মোবাইল নম্বর" value="{{ Auth::check() ? Auth::user()->mobile : '' }}" {{ Auth::check() ? 'readonly' : '' }}>
                    ...
                    <div class="row g-4 mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="education_qualification" class="form-control"
                                id="education_qualification" required placeholder="যেমন: বিএ/এমএ/সমমান">
                    ...
                    <div class="row g-4 mb-3" id="spouse_details_div" style="display: none;">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="spouse_profession" class="form-control" id="spouse_profession"
                                placeholder="স্বামী/স্ত্রীর পেশা">
                    ...
                    <div class="row g-4 mb-3">
                        <div class="col-md-6">
                            ...
                            <textarea name="present_address" class="form-control" id="present_address" rows="3"
                                style="height: auto !important;" required placeholder="বর্তমান যোগাযোগের ঠিকানা"></textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="permanent_address" class="form-control" id="permanent_address" rows="3"
                                style="height: auto !important;" required placeholder="স্থায়ী ঠিকানা"></textarea>
                            <small class="error-text error permanent_address_error"></small>
                        </div>
                    </div>

                    <!-- 4. Profession & Income -->
                    <h5 class="section-title fs-6"><i class="fas fa-briefcase"></i> পেশা ও আয়</h5>
                    <div class="row g-4 mb-3">
                        <div class="col-md-4">
                            <label for="profession_details">পেশার বিবরণ <span class="text-danger">*</span></label>
                            <input type="text" name="profession_details" class="form-control" id="profession_details"
                                required placeholder="পেশা বা ব্যবসায়ের বিবরণ">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="annual_income" class="form-control" id="annual_income" required
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="income_source" class="form-control" id="income_source" required
                                placeholder="আয়ের প্রধান উৎস">
                    ...
                    <div class="row g-4 mb-3">
                        <div class="col-md-6">
                            ...
                            <textarea name="profession_address" class="form-control" id="profession_address" rows="2"
                                style="height: auto !important;"
                                placeholder="কর্মস্থল বা প্রতিষ্ঠানের নাম ও ঠিকানা"></textarea>
                            <small class="error-text error profession_address_error"></small>
                        </div>
                        <div class="col-md-6">
                            <label for="tin_no">আয়কর টিআইএন নম্বর</label>
                            <input type="number" name="tin_no" class="form-control" id="tin_no"
                                placeholder="১২ ডিজিটের টিআইএন (TIN)">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <textarea name="tax_history_details" class="form-control" id="tax_history_details" rows="2"
                                style="height: auto !important;"
                                placeholder="কর বছর এবং করের পরিমাণসহ বিবরণ দিন (যেমন: ২০২২-২৩: ৫০,০০০ টাকা)"></textarea>
                            <small class="error-text error tax_history_details_error"></small>
                        </div>
                    </div>

                    <!-- 5. Government Employee fields -->
                    <h5 class="section-title fs-6"><i class="fas fa-user-tie"></i> সরকারি কর্মচারী সংক্রান্ত</h5>
                    <div class="row g-4 mb-3">
                        <div class="col-md-6">
                            <label for="is_govt_employee">আবেদনকারী কি একজন সরকারি কর্মচারী? <span
                                    class="text-danger">*</span></label>
                    ...
                    <div id="govt_employee_details_div" style="display: none;" class="mb-3">
                        <div class="row g-4 mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="cadre_service_name" class="form-control" id="cadre_service_name"
                                    placeholder="যেমন: বিসিএস (প্রশাসন)">
                                <small class="error-text error cadre_service_name_error"></small>
                            </div>
                            <div class="col-md-4">
                                <label for="designation">পদবী</label>
                                <input type="text" name="designation" class="form-control" id="designation"
                                    placeholder="বর্তমান পদবী">
                                <small class="error-text error designation_error"></small>
                            </div>
                            <div class="col-md-4">
                                <label for="pay_grade_salary">বেতন গ্রেড ও মূলবেতন</label>
                                <input type="text" name="pay_grade_salary" class="form-control" id="pay_grade_salary"
                                    placeholder="যেমন: ৯ম গ্রেড, ২২,০০০/-">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea name="workplace_address" class="form-control" id="workplace_address" rows="2"
                                    style="height: auto !important;"
                                    placeholder="বর্তমান কর্মস্থলের পূর্ণাঙ্গ ঠিকানা"></textarea>
                    ...
                    <h5 class="section-title fs-6"><i class="fas fa-history"></i> পূর্ববর্তী অস্ত্রের বিবরণ</h5>
                    <div class="row g-4 mb-3">
                        <div class="col-md-6">
                            <label for="duty_free_import">ইতঃপূর্বে শুল্কমুক্ত সুবিধায় বিদেশ হতে অস্ত্র আমদানি করেছেন
                                কি?</label>
                            <input type="text" name="duty_free_import" class="form-control" id="duty_free_import"
                                placeholder="আমদানি করে থাকলে অস্ত্রের বিবরণ, অন্যথায় 'না' লিখুন">
                            <small class="error-text error duty_free_import_error"></small>
                        </div>
                        <div class="col-md-6">
                            <label for="license_cancelled_before">ইতঃপূর্বে কোনো আগ্নেয়াস্ত্রের লাইসেন্স বাতিল করা হয়েছে কি?
                                <span class="text-danger">*</span></label>
                            <select name="license_cancelled_before" class="form-control" id="license_cancelled_before"
                                required>
                                <option value="0" selected>না</option>
                                <option value="1">হ্যাঁ</option>
                            </select>
                    ...
                    <div id="cancellation_details_div" style="display: none;" class="mb-3">
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="cancelled_weapon_type" class="form-control"
                                    id="cancelled_weapon_type" placeholder="অস্ত্রের ধরণ ও লাইসেন্স নম্বর">
                                <small class="error-text error cancelled_weapon_type_error"></small>
                            </div>
                            <div class="col-md-6">
                                <label for="cancellation_reason">বাতিলের কারণ</label>
                                <textarea name="cancellation_reason" class="form-control" id="cancellation_reason" rows="2"
                                    style="height: auto !important;" placeholder="লাইসেন্স বাতিলের কারণ"></textarea>
                    ...
                    <h5 class="section-title fs-6"><i class="fas fa-crosshairs"></i> চাহিত অস্ত্র ও হলফনামা</h5>
                    <div class="row g-4 mb-3">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="weapon_count" class="form-control" id="weapon_count" value="1"
                                min="1" required>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="necessity_reason">কী কারণে চাহিত আগ্নেয়াস্ত্র লাইসেন্সের প্রয়োজন <span
                                    class="text-danger">*</span></label>
                            <textarea name="necessity_reason" class="form-control" id="necessity_reason" rows="3"
                                style="height: auto !important;" required
                                placeholder="অস্ত্র লাইসেন্সের যৌক্তিকতা ব্যাখ্যা করুন"></textarea>
                    ...
                    <div class="row g-4 mb-3">
                        <div class="col-md-6">
                            <label for="affidavit_attached">হলফনামা প্রদান করা হয়েছে কি? <span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <label for="heir_deed_attached">না-দাবীনামা সংযুক্ত করা হয়েছে কি? <span
                                    class="text-danger">*</span></label>
