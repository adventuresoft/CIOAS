            ...
            <form id="publicPersonGunForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-4 mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="district_magistrate" class="form-control" id="district_magistrate" required
                ...
                <div class="row g-4 mb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="age_at_application" class="form-control" id="age_at_application" required
                            placeholder="আবেদনের তারিখে বয়স">
                ...
                <div class="row g-4 mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="education_qualification" class="form-control" id="education_qualification"
                            required placeholder="যেমন: বিএ/এমএ/সমমান">
                ...
                <div class="row g-4 mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="profession_details" class="form-control" id="profession_details" required
                            placeholder="পেশা বা ব্যবসায়ের বিবরণ">
                ...
                <div class="row g-4 mb-3">
                    <div class="col-md-6">
                        ...
                        <textarea name="profession_address" class="form-control" id="profession_address" rows="2"
                            style="height: auto !important;" placeholder="কর্মস্থল বা প্রতিষ্ঠানের নাম ও ঠিকানা"></textarea>
                ...
                <div id="cancellation_details_div" style="display: none;" class="mb-3">
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="cancelled_weapon_type" class="form-control" id="cancelled_weapon_type"
                                placeholder="অস্ত্রের ধরণ ও লাইসেন্স নম্বর">
                ...
                <div class="row g-4 mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="weapon_count" class="form-control" id="weapon_count" value="1" min="1"
                            required>
