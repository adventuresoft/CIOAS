            ...
            <div class="col-md-8 col-lg-6">
                <div class="bg-white rounded-3 shadow-sm border-top border-5 border-success overflow-hidden">
                    ...
                    <div class="p-4 text-center"
                        ...
                        <h4 class="text-white fw-bold mb-1">{{ $title ?? 'আবেদন সম্পন্ন হয়েছে!' }}</h4>
                    ...
                    <div class="p-4 p-md-5 text-center">
                        @if ($application_id)
                            <div class="rounded p-4 mb-4 border border-success" style="background-color: #f0fdf4;">
                                <p class="text-muted fw-bold mb-2">আপনার ট্র্যাকিং নম্বর (Tracking No):</p>
                            ...
                            <p class="text-secondary mb-4">
                                ভবিষ্যতের অনুসন্ধান ও অবস্থা যাচাইয়ের জন্য দয়া করে ট্র্যাকিং নম্বরটি সংরক্ষণ করুন। আপনার
                        ...
                        <div class="d-flex flex-column flex-sm-row justify-content-center gap-3">
                            <a href="{{ route('home') }}" class="btn btn-light border px-4 py-2 shadow-sm text-dark">
                                <i class="fas fa-home text-muted me-1"></i> হোম পেজে ফিরে যান
                            </a>
                            <a href="{{ route('frontend.gun-license.select') }}" class="btn btn-success px-4 py-2 shadow-sm"
                                style="background-color: #006a4e; border-color: #006a4e;">
                                <i class="fas fa-plus me-1"></i> নতুন আবেদন করুন
                            </a>
                        </div>
                    </div>

                    <!-- Footer Info -->
                    <div class="bg-light px-4 py-3 border-top text-center text-muted small">
