...
@push('style')
    ...
    <style>
        * {
        ...
        .book-hero .breadcrumb-item,
        .book-hero .breadcrumb-item a {
            color: rgba(255, 255, 255, 0.6);
            font-size: 12px;
            text-decoration: none;
        }

        .book-hero .breadcrumb-item.active {
            color: #fff;
        }

        .book-hero .breadcrumb-item+.breadcrumb-item::before {
