...
@section('content')
    <!-- Welcome Header Banner -->
        <div
            ...
            <div>
                <h5 class="fw-bold mb-1">স্বাগতম, {{ $user->name }}!</h5>
                <p class="text-white-50 mb-0 fs-content">আপনার নাগরিক ড্যাশবোর্ড থেকে সহজেই আবেদন এবং অ্যাপয়েন্টমেন্ট
                    ট্র্যাকিং করুন।</p>
            </div>
            <div class="d-flex align-items-center gap-3 bg-white bg-opacity-10 px-4 py-3 rounded-3"
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-6 col-md-3">
                <div class="stat-card bg-white p-3 rounded-4 h-100 d-flex align-items-center justify-content-between">
                    <div>
                        <p class="text-muted fw-bold text-uppercase mb-1" style="font-size: 11px;">অ্যাপয়েন্টমেন্ট বুকিং
                        </p>
            ...
            <div class="col-lg-4">
                ...
                <div class="theme-form-card">
                    <div class="text-center mb-4">
                        ...
                        <span
                            class="badge bg-danger bg-opacity-10 text-danger border border-danger border-opacity-25 rounded-pill px-3 py-1">নিবন্ধিত
                            নাগরিক</span>
                    </div>
                ...
                <div class="theme-form-card">
                    ...
                    <div class="d-flex flex-column gap-2">
                        <a href="{{ route('frontend.license.create') }}"
                            class="quick-action-link text-decoration-none d-flex align-items-center justify-content-between p-3 rounded-3 border border-light text-dark fw-bold fs-content">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-3 py-3 text-center">
                                            @if(in_array($app['status'], ['pending', 'Submitted', 'pending_approval', '0']))
                                                <span
                                                    class="badge badge-pending rounded-pill px-3 py-2 border border-warning border-opacity-25 text-dark">অপেক্ষমাণ</span>
                                            @elseif(in_array($app['status'], ['approved', 'Approved', 'active', '1']))
                                                <span
                                                    class="badge badge-approved rounded-pill px-3 py-2 border border-success border-opacity-25 text-dark">অনুমোদিত</span>
                                            @elseif($app['status'] == 'repaired')
                                                <span
                                                    class="badge badge-repaired rounded-pill px-3 py-2 border border-info border-opacity-25 text-dark">মেরামতকৃত</span>
                                            @else
                                                <span
                                                    class="badge badge-rejected rounded-pill px-3 py-2 border border-danger border-opacity-25 text-dark">বাতিল</span>
                                            @endif
                                        </td>
                                        <td class="px-3 py-3 text-center">
                                            <button type="button"
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-center py-5">
                                            <div class="text-muted d-flex flex-column align-items-center">
                                                ...
                                                <p class="mb-0 fs-6">কোন আবেদনের তথ্য পাওয়া যায়নি।</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 border-0 shadow-lg">
                ...
                <div class="modal-footer border-top-0 py-3 bg-light rounded-bottom-4">
                    <button type="button" class="btn btn-secondary px-4 rounded-3" data-bs-dismiss="modal">বন্ধ
                        করুন</button>
                </div>
            </div>
        </div>
