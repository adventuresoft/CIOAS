            ...
            <form action="{{ route('inquiry.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-4 mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" required name="applicant_name" placeholder="আবেদনকারীর নাম" class="form-control"
                            id="applicant_name">
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row g-4 mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="number" required name="mobile_number" placeholder="মোবাইল নম্বর" class="form-control"
