<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="sidebar">
    ...
    @endif
      ...
      <li class="nav-item has-treeview {{isset($page) && ($page=='role' || $page=='permission'|| $page=='rolepermission'|| $page=='userper' || $page=='roleuser'|| $page=='user' )?'menu-open':'' }}">
               <a href="#" class="nav-link {{isset($page) && ($page=='role' || $page=='permission'|| $page=='rolepermission'|| $page=='userper' || $page=='roleuser'|| $page=='user')?'active':'' }}">
               ...
               <ul class="nav nav-treeview">
                 ...
                 <li class="nav-item ">
                   <a href="{{route('role.index')}}" class="nav-link {{isset($page) && ($page=='role')?'active':'' }}">
                 ...
                 <li class="nav-item ">
                   <a href="{{route('permission.index')}}" class="nav-link {{isset($page) && ($page=='permission')?'active':'' }}">
                 ...
                 <li class="nav-item ">
                   <a href="{{route('roleuser.index')}}" class="nav-link {{isset($page) && ($page=='roleuser')?'active':'' }}">
                 ...
                 <li class="nav-item ">
                   <a href="{{route('rolepermission.index')}}" class="nav-link {{isset($page) && ($page=='rolepermission')?'active':'' }}">
                 ...
                 <li class="nav-item ">
                   <a href="{{route('user.index')}}" class="nav-link {{isset($page) && ($page=='user')?'active':'' }}">
                 ...
                 <li class="nav-item ">
                   <a href="{{route('userper.index')}}" class="nav-link {{isset($page) && ($page=='userper')?'active':'' }}">
