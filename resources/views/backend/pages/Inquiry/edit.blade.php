                    ...
                    <div class="cioas-shell">
                        ...
                        <div class="cioas-panel mb-4">
                            <div class="cioas-panel-header d-flex justify-content-between align-items-center">
                                <h3 class="cioas-panel-title m-0"><i class="fas fa-info-circle text-primary"></i> User Inquiry Information</h3>
                                @if($inquiry->status)
                                    @php
                                    ...
                                    @endphp
                                    <span class="badge badge-{{ $badgeClass }} px-3 py-2" style="font-size: 0.9rem;">{{ $inquiry->status }}</span>
                                @endif
                            </div>
                        ...
                        <!-- Admin Action Card -->
                        <div class="cioas-panel border-warning">
                            <div class="cioas-panel-header">
                                <h3 class="cioas-panel-title"><i class="fas fa-edit text-warning"></i> Admin Action</h3>
                            </div>
                            <form id="FormSubmit" method="POST" data-url="{{ route('inquiry.update', $inquiry->id) }}" data-redirect-url="{{ route('inquiry.formlist') }}">
                                ...
                                <div class="cioas-actions">
                                    <a href="{{ route('inquiry.formlist') }}" class="btn btn-default mr-2"><i class="fas fa-times"></i> Cancel</a>
                                    <button type="submit" class="btn btn-material btn-material-primary"><i class="fas fa-save"></i> Save Changes</button>
                                </div>
                            </form>
                        </div>
                    </div>
