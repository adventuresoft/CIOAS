...
@section('content')
    ...
    @php
        ...
        $statusClass = $inquiry->status ?? 'pending';
        $statusIcon = match ($inquiry->status) {
            'pending' => 'fa-clock',
    ...
    <section class="content application-view-container">
        <div class="container-fluid">
            ...
            @if($inquiry->revision_note && $inquiry->final_approved_by == null)
                    ...
                    <div class="control-card">
                        ...
                        <div class="control-card-body">
                            ...
                            <div class="meta-item">
                                ...
                                <div class="meta-val">{{ $inquiry->currentDepartment->name ?? '-' }}</div>
                            </div>

                            <div class="meta-item">
                                <div class="meta-label">নথির বর্তমান শাখা (Section)</div>
                                <div class="meta-val">{{ $inquiry->currentSection->name ?? '-' }}</div>
                            </div>

                            <div class="meta-item">
                                <div class="meta-label">গৃহীতকারী কর্মকর্তা</div>
                                <div class="meta-val">
                                    {{ $inquiry->initialApprover->name ?? ($inquiry->receiver->name ?? '-') }}
                                </div>
                            </div>
                            ...
                            <div class="control-card-body">
                                <div class="form-group mb-0">
                                    ...
                                    <div class="p-3 bg-light border rounded text-dark mb-0"
                                        ...
                                        {{ $inquiry->approval_note ?: 'কোন মন্তব্য করা হয়নি।' }}
                                    </div>
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <select name="department_id" id="department_id" class="form-control form-control-sm"
                                                    ...
                                                    @foreach ($departments as $department)
                                                        <option value="{{ $department->id }}" {{ (int) $inquiry->current_department_id === (int) $department->id ? 'selected' : '' }}>
                                                            {{ $department->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <select name="section_id" id="section_id" class="form-control form-control-sm" required>
                                                    ...
                                                    @foreach ($sections as $section)
                                                        <option value="{{ $section->id }}" {{ (int) $inquiry->current_section_id === (int) $section->id ? 'selected' : '' }}>
                                                            {{ $section->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                    ...
                    <div class="control-card">
                        ...
                        <div class="control-card-body p-3">
                            <div class="timeline-routing">
                                @forelse ($inquiry->assignments as $key => $assign)
                                    @php
                                        $nodeClass = 'info';
                                        $iconClass = 'fa-paper-plane';
                                        if ($key === 0) {
                                            $nodeClass = match ($inquiry->status) {
                                                'pending' => 'warning',
                                                'assigned' => 'info',
                                                'received' => 'success',
                                                'processing' => 'warning',
                                            ...
                                            $iconClass = match ($inquiry->status) {
                                                'pending' => 'fa-clock',
                                                'assigned' => 'fa-paper-plane',
                                                'received' => 'fa-inbox',
                                                'processing' => 'fa-sync-alt fa-spin',
                                    ...
                                    <div class="timeline-node {{ $nodeClass }}">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="timeline-title">
                                                @if ($key === 0)
                                                    বর্তমান অবস্থা: {{ ucfirst($inquiry->status ?? 'pending') }}
                                                @else
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#assignForm').on('submit', function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('inquiry.assign', $inquiry->id) }}",
