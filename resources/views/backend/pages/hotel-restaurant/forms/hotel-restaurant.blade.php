                ...
                @if (isset($thanas))
                    @foreach ($thanas as $thana)
                        <option
                            ...
                            value="{{ $organization->thana_id ?? '' }}">{{ $thana->name ?? 'Select Thana' }}</option>
                    @endforeach
                @endif
            </select>
            ...
            <select name="office_district_id" class="form-control select2 select2bs4" id="office_district_id">
                @if (isset($office_districts))
                    @foreach ($office_districts as $district)
                        <option value="{{ $organization->office_district_id ?? '' }}"
                ...
                @if (isset($office_thanas))
                    @foreach ($office_thanas as $thana)
                        <option
                            ...
                            value="{{ $organization->office_thana_id ?? '' }}">{{ $thana->name ?? 'Select Thana' }}
                        </option>
                    @endforeach
                @endif
            </select>
