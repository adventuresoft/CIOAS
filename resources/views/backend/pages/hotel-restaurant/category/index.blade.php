                                                    ...
                                                    <td>
                                                        <div class="table-action">
                                                            <a class="btn btn-sm btn-primary" title="Edit"
                                                                data-toggle="tooltip"
                                                                href="{{ route('basic-settings.family-category.edit', $item->id) }}"><i
                                                                    class="fa fa-edit"></i></a>
                                                            <a class="btn btn-sm btn-info" title="Show"
                                                                data-toggle="tooltip"
                                                                href="{{ route('basic-settings.family-category.show', $item->id) }}"><i
                                                                    class="fa fa-eye"></i></a>
                                                            ...
                                                            <form class="deleteCategory" method="post">
                                                                ...
                                                                <input type="hidden" class="deleteUrl" name="deleteUrl"
                                                                    value="{{ route('basic-settings.family-category.destroy', $item->id) }}">
