                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6 text-left">
                                    <h3 class="card-title">Hotel Ownership Type List</h3>
                                </div>
                                <div class="col-md-6 text-right">
                                    <a href="{{ route('basic-settings.ownership-type.create') }}"
                                                    ...
                                                    <td>
                                                        <div class="table-action">
                                                            <a class="btn btn-sm btn-primary" title="Edit"
                                                                data-toggle="tooltip"
                                                                href="{{ route('basic-settings.ownership-type.edit', $item->id) }}"><i
                                                                    class="fa fa-edit"></i></a>
                                                            <a class="btn btn-sm btn-info" title="Show"
                                                                data-toggle="tooltip"
                                                                href="{{ route('basic-settings.ownership-type.show', $item->id) }}"><i
                                                                    class="fa fa-eye"></i></a>
                                                            ...
                                                            <form class="deleteCategory" method="post">
                                                                ...
                                                                <input type="hidden" class="deleteUrl" name="deleteUrl"
                                                                    value="{{ route('basic-settings.ownership-type.destroy', $item->id) }}">
