...
@push('script')
    <script>
        $(document).ready(function() {
            ...
            if ($.fn.DataTable.isDataTable('#hotelRestaurant')) {
                $('#hotelRestaurant').DataTable().destroy();
            }
        ...
        $(document).ready(function() {
            ...
            let table = $('#hotelRestaurant').DataTable({
                ...
                drawCallback: function() {
                    // Re-bind delete functionality after table redraw
                    bindDeleteEvents();
                }
            });
                                    ...
                                    $.ajax({
                                        ...
                                        error: function(xhr, status, error) {
                                            thisForm.find(
                                                    'button[type="submit"]')
                                                .prop("disabled", false);
                                            var responseText = jQuery.parseJSON(
                                                xhr
                                                .responseText);
                                            toastr.error(responseText.message);
                                        }
