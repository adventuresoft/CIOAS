                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Edit Pourashava</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" id="pourashavaForm" action="{{route('basic-settings.pourashava.update', $pourashava->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-sm-2 col-form-label">Pourashava Name <span class="text-danger" title="Required" data-toggle="tooltip">*</span></label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="category" class="col-sm-2 col-form-label">Category <span class="text-danger" title="Required" data-toggle="tooltip">*</span></label>
                                    <div class="col-sm-9">
                            ...
                            <div class="card-footer">
                                <div class="form-group row">
                                    <a href="{{route('basic-settings.pourashava.index')}}" class="btn btn-default float-right">Cancel</a>
                                    <div class="col-sm-9">
