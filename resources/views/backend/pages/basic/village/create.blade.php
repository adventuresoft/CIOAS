...
@section('content')
    <section class="content cioas-page pt-4">
        <div class="container-fluid">
            <form id="villageForm" action="{{ route('basic-settings.village.store') }}" method="POST" class="form-horizontal">
                @csrf
                <div class="cioas-shell">
                    <div class="cioas-panel">
                        <div class="cioas-panel-header">
                            <h3 class="cioas-panel-title">
                                <i class="fas fa-home"></i> Village Info
                            </h3>
                        </div>
                        <div class="cioas-panel-body">
                                ...
                                <div class="col-sm-9 d-flex align-items-center">
                                    <div class="d-flex flex-wrap gap-4">
                                        <div class="form-check custom-radio">
                                            <input class="form-check-input location_type" type="radio" name="location_type" id="city_corporation" value="city_type">
                                            <label class="form-check-label" for="city_corporation">City Corporation</label>
                                        </div>
                                        <div class="form-check custom-radio">
                                            <input class="form-check-input location_type" type="radio" name="location_type" id="pourashava" value="pos_type">
                                            <label class="form-check-label" for="pourashava">Pourashava</label>
                                        </div>
                                        <div class="form-check custom-radio">
                                            <input class="form-check-input location_type" type="radio" name="location_type" id="union" value="union_type">
                            ...
                            <div class="form-group row mb-4 city_type d-none">
                            ...
                            <div class="form-group row mb-4 pos_type d-none">
                            ...
                            <div class="form-group row mb-4 union_type d-none">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="en_name" id="en_name" class="form-control" placeholder="Village Name (English)" required>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="bn_name" id="bn_name" class="form-control" placeholder="Village Name (Bengali)" required>
