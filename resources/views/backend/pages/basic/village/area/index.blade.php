            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('basic-settings.village-area.index') }}">Village
                                Area</a></li>
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    <a href="{{ route('basic-settings.village-area.create') }}"
                                                    ...
                                                    <td>
                                                        <div class="table-action">
                                                            <a class="btn btn-sm btn-primary" title="Edit"
                                                                data-toggle="tooltip"
                                                                href="{{ route('basic-settings.village-area.edit', $area->id) }}"><i
                                                                    class="fa fa-edit"></i></a>
                                                            <a class="btn btn-sm btn-info" title="Show"
                                                                data-toggle="tooltip"
                                                                href="{{ route('basic-settings.village-area.show', $area->id) }}"><i
                                                                    class="fa fa-eye"></i></a>
                                                            ...
                                                            <form class="deleteArea" method="post">
                                                                ...
                                                                <input type="hidden" class="deleteUrl" name="deleteUrl"
                                                                    value="{{ route('basic-settings.village-area.destroy', $area->id) }}">
                                                                <button type="submit" title="Edit" data-toggle="tooltip"
                            ...
                            $("#confirmationRevertYes").click(function() {
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        ...
                                        setTimeout(function() {
                                            location.href =
                                                "{{ route('basic-settings.village-area.index') }}";
                                        }, 2000)
                                    },
