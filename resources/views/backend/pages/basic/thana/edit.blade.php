                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Thana Info</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" id="thanaForm" method="POST"
                            ...
                            <div class="card-body">
                                        ...
                                        <select required class="form-control select2" name="district_id" id="district_id">
                                            ...
                                            @if ($districts)
                                                @foreach ($districts as $district)
                                                    <option value="{{ $district->id }}" @if($district->id == $thana->district_id) selected @endif>{{ $district->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-sm-2 col-form-label">Thana Name <span
                                            class="text-danger" title="Required" data-toggle="tooltip">*</span></label>
                                    <div class="col-sm-9">
                                        <input type="text" required name="name" placeholder="Thana Name"
                                            value="{{ $thana->name }}" class="form-control" id="name">
                                        <small class="text-danger error name_error"></small>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="bn_name" class="col-sm-2 col-form-label">Thana Name Bangla <span
                                            class="text-danger" title="Required" data-toggle="tooltip">*</span></label>
                                    <div class="col-sm-9">
                                        <input type="text" required name="bn_name" placeholder="Thana Name Bangla"
                                            value="{{ $thana->bn_name }}" class="form-control" id="bn_name">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select required class="form-control select2" name="status" id="status">
                                            <option value="1" @if($thana->status == 1) selected @endif>Active</option>
                                            <option value="0" @if($thana->status == 0) selected @endif>Inactive</option>
                                        </select>
            ...
            $("#thanaForm").on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        setTimeout(function() {
                            location.href =
                                "{{ route('basic-settings.thana.index') }}";
                        }, 2000)
                    },
