                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('basic-settings.department-section.index', $section->department_id) }}">Section
                                List</a></li>
            ...
            <div class="cioas-shell">
                <form class="form-horizontal" id="FormSubmit" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="col-md-6">
                                    <div class="md-field">
                                        ...
                                        <input type="text" name="name" placeholder="Section Name" class="form-control"
                                            id="name" value="{{ $section->name }}" required>
                    ...
                    <div class="cioas-actions mt-4">
                        <a href="{{ route('basic-settings.department-section.index', $section->department_id) }}"
