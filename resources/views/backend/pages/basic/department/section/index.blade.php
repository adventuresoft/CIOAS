        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('basic-settings.department.index') }}">Department</a></li>
            ...
            <div class="cioas-panel">
                <div class="cioas-panel-header">
                    ...
                    <div>
                        ...
                        <a href="{{ route('basic-settings.department-section.create', $department_id) }}" class="btn btn-material btn-material-primary">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) {
                            ...
                            if (window.LaravelDataTables && window.LaravelDataTables["department-section-table"]) {
                                window.LaravelDataTables["department-section-table"].ajax.reload();
                            } else {
