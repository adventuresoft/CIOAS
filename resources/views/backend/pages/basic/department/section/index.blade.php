...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ $section_lists[0]->department->name }} Section</h1>
                </div>
                <div class="col-sm-6">
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    ...
                                    <a href="{{ route('basic-settings.department-section.create', ['department_id' => request()->department_id]) }}"
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @if ($section_lists)
                                            @foreach ($section_lists as $key => $item)
                                                <tr>
                                                    <td>{{ ++$key }}</td>
                                                    <td>{{ $item->name }}</td>
                                                    <td>{{ $item->bn_name }}</td>
                                                        ...
                                                        <div class="table-action">
                                                            ...
                                                            <form class="deleteData" method="post">
                                                                ...
                                                                <input type="hidden" class="deleteUrl" name="deleteUrl"
                                                                    value="{{ route('basic-settings.department-section.destroy', $item->id) }}">
