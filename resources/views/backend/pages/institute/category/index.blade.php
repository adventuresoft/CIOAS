...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Institute Category List</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('institute-category.index') }}">Institute Type List</a>
                        </li>
                                            ...
                                            <td>
                                                <div class="table-action">
                                                    ...
                                                    <a class="btn btn-sm btn-primary" title="Edit" data-toggle="tooltip"
                                                        href="{{ route('institute-category.edit', $item->id) }}"><i
                                                    ...
                                                    <form class="deleteData" method="post">
                                                        ...
                                                        <input type="hidden" class="deleteUrl" name="deleteUrl"
                                                            value="{{ route('institute-category.destroy', $item->id) }}">
                                                        <input type="hidden" class="redirect-url" name="redirectUrl"
                                                            value="{{ route('institute-category.index') }}">
