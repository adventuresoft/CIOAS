...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6"><h1>License Category Create</h1></div>
            <div class="col-sm-6">
...
<section class="content">
    <div class="container-fluid">
        <div class="card card-info">
            <div class="card-header"><h3 class="card-title">License Category Info</h3></div>
...
$(document).ready(function() {
    $('#licenseCategoryForm').on('submit', function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: "{{ route('basic-settings.license-category.store') }}",
