...
@push('style')
@endpush
@section('title', 'License Category Details')
@section('content')
    <!-- Main content -->
            ...
            <div class="cioas-shell">
                <div class="cioas-panel">
                    <div class="cioas-panel-header">
                        <h3 class="cioas-panel-title">
                            <i class="fas fa-eye"></i> License Category Details
                        </h3>
                    </div>
                    <div class="cioas-panel-body">
                        ...
                        @else
                            <div class="alert alert-danger">
                                License Category information not found.
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="cioas-panel mt-3">
                    <div class="cioas-panel-body d-flex justify-content-end align-items-center">
                        <a href="{{ route('basic-settings.license-category.index') }}" class="btn btn-secondary btn-material">
