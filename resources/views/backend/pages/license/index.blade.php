        ...
        <div class="card card-info">
            ...
            <div class="card-body">
                <div class="row mb-3 align-items-center g-2">
                    ...
                    <div class="col-md-2"><input type="text" id="search_name" class="form-control form-control-sm" placeholder="License Name"></div>
                    <div class="col-md-2"><input type="text" id="search_category" class="form-control form-control-sm" placeholder="Category"></div>
                    <div class="col-md-2"><input type="text" id="search_subcategory" class="form-control form-control-sm" placeholder="Subcategory"></div>
                    <div class="col-md-2"><input type="text" id="search_license_no" class="form-control form-control-sm" placeholder="License No."></div>
                    <div class="col-md-2"><input type="text" id="search_global" class="form-control form-control-sm" placeholder="Search"></div>
                </div>
                        ...
                        @foreach ($licenses as $key => $license)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        @if (view_permission())
                                            <a href="{{ route('license.edit', $license->id) }}" title="Edit" class="btn btn-primary btn-sm mx-1"><i class="fa fa-edit"></i></a>
                                            <a href="{{ route('license.show', $license->id) }}" title="View" class="btn btn-info btn-sm mx-1"><i class="fa fa-eye"></i></a>
                                            <form class="deleteLicense d-inline" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <input type="hidden" class="deleteUrl" value="{{ route('license.destroy', $license->id) }}">
