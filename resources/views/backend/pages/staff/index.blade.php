                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <h3 class="card-title" style="font-size:20px; font-weight: semi-bold;">Staff Information
                                    </h3>
                                </div>
                                    ...
                                    @if ($users && count($users) > 0)
                                        @foreach ($users as $key => $user)
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ asset($user->image ?? 'default.png') }}" width="38" height="48"
                                                        class="img" onerror="this.src='{{ asset('default.png') }}'">
                                                </td>
