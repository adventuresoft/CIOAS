...
@section('content')
   ...
   <section class="content-header">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">
                                @include('backend.pages.staff.tabs.tab_header', ['user' => $user, 'active_tab' => 'health'])
                            </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <a href="{{ route('staff.index') }}" class="btn btn-outline-primary btn-block" style="color: #5b4bdf; border-color: #5b4bdf;">Complete <i class="fas fa-arrow-right ml-1"></i></a>
        </div>
    </div>
</div>
                            <!-- /.card-footer -->
