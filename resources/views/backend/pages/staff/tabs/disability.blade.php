...
@section('content')
    ...
    <div class="row">
        <div class="col-md-4">
            <a href="{{ route('staff.property', $user->id) }}" class="btn btn-outline-secondary btn-block"><i class="fas fa-arrow-left mr-1"></i> Property</a>
        </div>
        <div class="col-md-4">
    ...
    <script>
        $(document).ready(function() {
            $("#peopleDisabilityForm").on('submit', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('staff.disabilityStore') }}",
