...
@section('content')
                                        ...
                                        <select name="permanent_ward_id" class="form-control select2 select2bs4" id="permanent_ward_id">
                                            ...
                                            @if ($wards)
                                                @foreach ($wards as $ward)
                                                    <option value="{{$ward->id}}" {{$user->addressInfo ? (($user->addressInfo->permanent_ward_id == $ward->id) ? 'selected' : '' ) : ''}}>{{$ward->name}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        ...
                                        <select name="present_ward_id" class="form-control select2 select2bs4" id="present_ward_id">
                                            ...
                                            @if ($wards)
                                                @foreach ($wards as $ward)
                                                    <option value="{{$ward->id}}" {{$user->addressInfo ? (($user->addressInfo->present_ward_id == $ward->id) ? 'selected' : '' ) : ''}}>{{$ward->name}}</option>
                                                @endforeach
                                            @endif
                                        </select>
    ...
    <div class="row">
        <div class="col-md-4">
            <a href="{{ route('staff.family', $user->id) }}" class="btn btn-outline-secondary btn-block"><i class="fas fa-arrow-left mr-1"></i> Family</a>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            <a href="{{ route('staff.education', $user->id) }}" class="btn btn-outline-primary btn-block" style="color: #5b4bdf; border-color: #5b4bdf;">Education <i class="fas fa-arrow-right ml-1"></i></a>
        </div>
    </div>
</div>
                            <!-- /.card-footer -->
