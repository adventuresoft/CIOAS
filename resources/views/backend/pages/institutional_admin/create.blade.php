...
<div class="container-fluid py-4" style="min-height: 1000px;">
    ...
    <div class="row mb-3">
        <div class="col-sm-6">
            <h1 class="h3 font-weight-bold text-dark">Institutional Admin Create</h1>
        </div>
        <div class="col-sm-6">
    ...
    <div class="card premium-card">
        <div class="card-header">
            <h3 class="card-title">
                ...
                Register New Institutional Admin
            </h3>
        </div>
        ...
        <form id="institionalForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group mb-4">
                                <label class="form-label-premium" for="password">Access Password <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6 form-group mb-4">
                                <label class="form-label-premium" for="password_confirmation">Confirm Password <span class="text-danger">*</span></label>
            ...
            <div class="card-footer bg-white border-top-0 d-flex justify-content-start pb-4 px-4">
                <button type="submit" class="btn btn-primary btn-premium px-5 py-2 font-weight-bold" style="border-radius: 8px;"><i class="fas fa-check-circle mr-1"></i> Register Admin</button>
