                          ...
                          <td style="width: 10%">
                            <div class="table-action">
                              <a class="btn btn-sm btn-primary" title="Edit" data-toggle="tooltip"
                                href="{{route('institutional-admin.edit', $admin->id)}}"><i class="fa fa-edit"></i></a>
                              <a class="btn btn-sm btn-info" title="Show" data-toggle="tooltip"
                                href="{{route('institutional-admin.show', $admin->id)}}"><i class="fa fa-eye"></i></a>
                              ...
                              <form class="deleteInstitute" method="post">
                                ...
                                <input type="hidden" class="deleteUrl" name="deleteUrl"
                                  value="{{route('institutional-admin.destroy', $admin->id)}}">
                                <button type="submit" title="Delete" data-toggle="tooltip" class="btn btn-sm btn-danger"><i
