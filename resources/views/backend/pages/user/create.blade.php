...
@section('title', 'Register New Authorized Employee')
        ...
        <div class="card premium-card">
            <div class="card-header">
                <h3 class="card-title">
                    ...
                    Register New Authorized Employee
                </h3>
            </div>
            ...
            <form role="form" method="POST" action="{{ route('user.store') }}">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group mb-4">
                                    ...
                                    <input type="text" name="mobile" id="mobile"
                                        ...
                                        value="{{ old('mobile') }}" placeholder="e.g. 01700000000" required>
                                    @error('mobile')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group mb-4">
                                    ...
                                    <input type="password" name="password_confirmation" id="password_confirmation"
                                        class="form-control form-control-premium" placeholder="Repeat password" required>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-footer bg-white border-top-0 d-flex justify-content-start pb-4 px-4">
                    <button type="submit" class="btn btn-primary btn-premium px-5 py-2 font-weight-bold"
                        style="border-radius: 8px;"><i class="fas fa-check-circle mr-1"></i> Register Employee</button>
