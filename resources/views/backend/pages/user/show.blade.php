            ...
            <div class="col-md-4">
                <div class="card premium-card text-center py-4">
                    <div class="card-body">
                        ...
                        @else
                            <span class="badge badge-warning px-3 py-2 font-weight-bold" style="border-radius: 9999px;"><i
                                    class="fas fa-clock mr-1"></i> Pending Review</span>
                        @endif
                        ...
                        <div class="d-flex justify-content-center" style="gap: 12px;">
                            <a href="{{ route('user.edit', $user->id) }}"
                                class="btn btn-primary btn-sm px-3 font-weight-bold" style="border-radius: 6px;">
                                <i class="fas fa-edit mr-1"></i> Modify Profile
                            </a>
                            <a href="{{ route('user.index') }}" class="btn btn-light btn-sm px-3 font-weight-bold"
                ...
                <div class="card premium-card">
                    <div class="card-header">
                        <h3 class="card-title">
                            ...
                            Security Employee Profile Details
                        </h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                ...
                                @foreach ($groupedPerms as $module => $count)
                                    <span class="d-inline-flex align-items-center bg-light border px-3 py-2 text-dark"
                                        ...
                                        <span class="badge badge-secondary ml-2"
                                            style="background-color: #64748b; color: #fff; font-size: 0.75rem; padding: 3px 6px; border-radius: 4px;">{{ $count }}</span>
                                    </span>
                                @endforeach
                            </div>
                        @else
