...
@section('title', 'Modify Authorized Operator')
    ...
    <div class="card premium-card">
        <div class="card-header">
            <h3 class="card-title">
                ...
                Modify Authorized Operator : {{ $user->name }}
            </h3>
        </div>
        ...
        <form role="form" method="POST" action="{{ route('user.update', $user->id) }}">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group mb-4">
                                ...
                                <small class="text-muted d-block mt-1">Leave blank if password remains unchanged.</small>
                                @error('password')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
            ...
            <div class="card-footer bg-white border-top-0 d-flex justify-content-start pb-4 px-4">
                <button type="submit" class="btn btn-primary btn-premium px-5 py-2 font-weight-bold" style="border-radius: 8px;"><i class="fas fa-check-circle mr-1"></i> Update Operator</button>
