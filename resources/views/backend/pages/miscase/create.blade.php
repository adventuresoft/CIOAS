...
@section('content')
@php
    $caseNoValue = sprintf('CASE%05d', (\App\Models\MisCase::max('id') ?? 0) + 1);
                            ...
                            <div class="col-md-4">
                                <div class="md-field">
                                    ...
                                    <input type="date" name="case_date" id="case_date" class="form-control md-control"
                                        value="{{ old('case_date', date('Y-m-d')) }}"
                                        required>
                            ...
                            <div class="col-md-4">
                                <div class="md-field">
                                    ...
                                    <select name="case_type" id="case_type" class="form-control ">
                                        ...
                                        <option value="1" @selected(old('case_type') == '1')>শ্রেণি পরিবর্তন</option>
                                        <option value="2" @selected(old('case_type') == '2')> নামজারি সংক্রান্ত</option>
                                        <option value="3" @selected(old('case_type') == '3')>মুদ্রণজনিত ত্রুটি</option>
                                        <option value="4" @selected(old('case_type') == '4')>নিলাম বিজ্ঞপ্তি</option>
                                        <option value="5" @selected(old('case_type') == '5')>অর্পিত থেকে খাস করা</option>
                                        <option value="6" @selected(old('case_type') == '6')>বন্দোবস্ত মামলা</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
