            ...
            <form id="personApplicationForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="cioas-panel">
                    <div class="cioas-panel-header">
                        <h3 class="cioas-panel-title"><i class="fas fa-file-signature"></i> Personal Application Form</h3>
                    </div>
                ...
                <div class="cioas-actions">
                    <button type="submit" class="btn btn-material btn-material-primary">Submit Application</button>
                </div>
            </form>
        </div>
    </div>
