...
content = re.sub(section_start, r'<div id="routeAllocationSection" style="display: none;">\n                            \1', content)
...
# Add JS toggle
js_find = r'(populateSelect\(\$category, categories, "Select Vehicle Category"\);\s*\}\);)'
js_replace = r'''\1
...
with open('resources/views/backend/pages/vehicle/create.blade.php', 'w') as f:
    f.write(content)
