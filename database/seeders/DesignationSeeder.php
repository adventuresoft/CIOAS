...
class DesignationSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $nazir       = Department::where('name', 'Nazir')->first();
        ...
        $designations = [
            ...
            // Nazir
            [ 'department_id' => $nazir->id, 'name' => 'Nazir Officer', 'bn_name' => 'নাজির' ],
            [ 'department_id' => $nazir->id, 'name' => 'Assistant Nazir', 'bn_name' => 'সহকারী নাজির' ],
            [ 'department_id' => $nazir->id, 'name' => 'Accountant', 'bn_name' => 'হিসাব রক্ষক' ],
