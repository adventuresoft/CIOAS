...
class MouzaDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', 'backend.pages.basic.mouza.action')
    ...
    {
        return $model->newQuery()->with(['upazila']);
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('name')->title('Mouza Name'),
            Column::make('bn_name')->title('Bengali Name'),
            Column::make('upazila_id')->title('Upazila'),
