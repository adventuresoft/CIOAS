...
class LicenseCategoryDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', 'backend.pages.license.category.action')
     ...
     */
    public function query(LicenseCategory $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('licensecategory-table')
    ...
    {
        return 'LicenseCategory_' . date('YmdHis');
    }
}
