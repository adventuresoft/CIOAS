...
class InstituteTypeDataTable extends DataTable
{
        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function($row) {
                ...
                <div class="d-flex justify-content-center align-items-center" style="gap: 8px;">
                    <a href="' . route('institute-type.edit', $row->id) . '" class="btn btn-primary btn-sm" title="Edit" style="border-radius:4px;"><i class="fas fa-edit"></i></a>
                    <form action="' . route('institute-type.destroy', $row->id) . '" method="POST" class="deleteData d-inline">
     ...
     */
    public function query(InstituteType $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('institutetype-table')
