...
class InventoryVendorAssignedDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', 'backend.pages.inventory.vendor.assigned_action')
            ...
            ->addIndexColumn()
            ->rawColumns(['work_order_info', 'total_items', 'action'])
            ->setRowId('id');
    }
    ...
    {
        return $this->builder()
            ->setTableId('inventoryvendorassigned-table')
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('total_items')->title('Total Items')->addClass('text-center'),
    ...
    {
        return 'InventoryVendorAssigned_' . date('YmdHis');
    }
}
