...
class StaffPropertyInfoController extends Controller
{
    /**
    ...
    public function create($id)
    {
        ...
        return view('backend.pages.staff.tabs.property', $data);
    }
        ...
        // try {
            ...
            $result = DB::transaction(function () use ($request) {
                ...
                if ($peopleFamily) {
                    ...
                    $data['code'] = 200;
                    $data['redirect_url'] = route('staff.disability', $request->user_id);
                    return $data;
                } else {
                    $data['status'] = false;
