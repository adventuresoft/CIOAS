...
class StaffFamilyInfoController extends Controller
{
    /**
    ...
    public function create($id)
    {
        ...
        return view('backend.pages.staff.tabs.family', $data);
    }
    ...
    public function store(Request $request)
    {
            ...
            // try {
                ...
                if ($peopleFamily) {
                    ...
                    $data['redirect_url'] = route('staff.address', $request->user_id);
