...
class StaffDisabilityInfoController extends Controller
{
    /**
    ...
    public function create($id)
    {
        ...
        return view('backend.pages.staff.tabs.disability', $data);
    }
    ...
    public function store(Request $request)
    {
            ...
            $query = DB::transaction(function () use ($request) {
                ...
                try {
                    ...
                    $data['code'] = 200;
                    $data['redirect_url'] = route('staff.freedom', $request->user_id);
                    return $data;
                } catch (\Throwable $th) {
                    $data['status'] = false;
